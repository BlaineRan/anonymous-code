...
class MCTSArchitectureSearcher:
    ...
    def _mcts_iteration(self, dataset_name: str, dataloader, save_dir: str, iteration: int) -> Optional[ArchitectureNode]:
        ...
        # The reward here becomes the score later
    ...
    def _save_dataset_results(self, dataset_name: str, save_dir: str, 
        ...
        for arch in best_architectures:
            node_info = arch.get_node_info() # Full node information; the modifications section can be removed.
...
def main():
    ...
    parser.add_argument('--max_peak_memory', type=float, default=None,
                       help='Maximum peak memory limit in MB (e.g., 20 means 20MB)')
    ...
    dataset_names = ['Wharf']  # Or ['USCHAD', 'UTD-MHAD', 'Mhealth', 'MMAct'] for multiple datasets
    ...
    try:
        ...
        print(f"\n✅ Detailed results saved to: /root/tinyml/weights/mcts_search_ablation_quant/")
