...
class MCTSArchitectureSearcher:
    ...
    def __init__(self, llm_config: Dict[str, Any], search_space: Dict[str, Any], 
        ...
        self.llm_expander = LLMRZNASExpander(llm_config, search_space, self.dataset_info)
        # 需要在初始化完成后设置图结构引用
    ...
    def search(self, total_iterations: int = 100, max_runtime_seconds: int = 3600) -> Dict[str, Any]:
        ...
        base_save_dir = "/root/tinyml/weights/rznas_quant"
...
def main():
    ...
    try:
        ...
        print(f"\n✅ 详细结果已保存到: /root/tinyml/weights/rznas_quant/")
